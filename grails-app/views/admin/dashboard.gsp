...
<div class="content mt-3">
    ...
    <div class="col-sm-6 col-lg-3">
        <div class="card text-white bg-flat-color-1">
            <div class="card-body pb-0">
                ...
                <div class="chart-wrapper px-0" style="height:70px;" height="70"><iframe class="chartjs-hidden-iframe"
                                                                                         tabindex="-1"
                    ...
                    <canvas id="widgetChart1" height="70" width="145"
                            style="display: block; width: 145px; height: 70px;"></canvas>
                </div>
        ...
        <div class="card text-white bg-flat-color-2">
            <div class="card-body pb-0">
                ...
                <div class="chart-wrapper px-0" style="height:70px;" height="70"><iframe class="chartjs-hidden-iframe"
                                                                                         tabindex="-1"
                                                                                         style="display: block; overflow: hidden; border: 0px; margin: 0px; top: 0px; left: 0px; bottom: 0px; right: 0px; height: 100%; width: 100%; position: absolute; pointer-events: none; z-index: -1;"></iframe>
                    <canvas id="widgetChart2" height="70" width="145"
                            style="display: block; width: 145px; height: 70px;"></canvas>
                </div>
    ...
    <div class="col-sm-6 col-lg-3">
        <div class="card text-white bg-flat-color-3">
            ...
            <div class="chart-wrapper px-0" style="height:70px;" height="70"><iframe class="chartjs-hidden-iframe"
                                                                                     tabindex="-1"
                                                                                     style="display: block; overflow: hidden; border: 0px; margin: 0px; top: 0px; left: 0px; bottom: 0px; right: 0px; height: 100%; width: 100%; position: absolute; pointer-events: none; z-index: -1;"></iframe>
                <canvas id="widgetChart3" height="40" width="175"
                        style="display: block; width: 175px; height: 40px;"></canvas>
            </div>
        </div>
    </div>
    <!--/.col-->
    ...
    <div class="col-sm-6 col-lg-3">
        <div class="card text-white bg-flat-color-4">
            <div class="card-body pb-0">
                ...
                <div class="chart-wrapper px-3" style="height:70px;" height="70"><iframe class="chartjs-hidden-iframe"
                                                                                         tabindex="-1"
                                                                                         style="display: block; overflow: hidden; border: 0px; margin: 0px; top: 0px; left: 0px; bottom: 0px; right: 0px; height: 100%; width: 100%; position: absolute; pointer-events: none; z-index: -1;"></iframe>
                    <canvas id="widgetChart4" height="26" width="113"
                            style="display: block; width: 113px; height: 26px;"></canvas>
                </div>
    ...
    <div class="col-lg-3 col-md-6">
        <div class="social-box google-plus">
            ...
            <ul>
                <li>
                    <sctrong><span class="count">94</span> k
                        <span>followers</span>
                    </sctrong></li>
                <li>
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-body">
                ...
                <div class="chart-wrapper mt-4"><iframe class="chartjs-hidden-iframe" tabindex="-1"
                                                        style="display: block; overflow: hidden; border: 0px; margin: 0px; top: 0px; left: 0px; bottom: 0px; right: 0px; height: 100%; width: 100%; position: absolute; pointer-events: none; z-index: -1;"></iframe>
                    <canvas id="trafficChart" style="height: 510px; display: block; width: 765px;" height="510"
                            width="765"></canvas>
                </div>
    ...
    <div class="col-xl-3 col-lg-6">
        <section class="card">
            <div class="twt-feed blue-bg">
                ...
                <div class="media">
                    <a href="#">
                        <asset:image src="images/admin.jpg" class="align-self-center rounded-circle mr-3"
    ...
    <div class="col-xl-6">
        <div class="card">
            ...
            <div class="Vector-map-js">
                <div id="vmap" class="vmap" style="height: 265px; position: relative; overflow: hidden;"><svg
                        width="795" height="265"><g transform="scale(0.4818181818181818) translate(350, 0)"><path
                            ...
                            stroke-opacity="0.25" fill="#0fc6d8" original="#0fc6d8" id="jqvmap1_id"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#17dac4" original="#17dac4" id="jqvmap1_pg"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#0ec4db" original="#0ec4db" id="jqvmap1_mx"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#16d8c7" original="#16d8c7" id="jqvmap1_ee"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#12cfd0" original="#12cfd0" id="jqvmap1_dz"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#14d2cd" original="#14d2cd" id="jqvmap1_ma"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#18ddc2" original="#18ddc2" id="jqvmap1_mr"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#17d9c5" original="#17d9c5" id="jqvmap1_sn"
                            class="jqvmap-region"></path><path
                            d="M406.89,298.34l-0.13,1.11l6.92-0.1l0.35-1.03l-0.15-1.04l-1.99,0.81L406.89,298.34L406.89,298.34z"
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#19e0bf" original="#19e0bf" id="jqvmap1_gm"
                            class="jqvmap-region"></path><path
                            d="M408.6,304.53l1.4,2.77l3.93-3.38l0.04-1.04l-4.63-0.67L408.6,304.53L408.6,304.53z"
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#19e0bf" original="#19e0bf" id="jqvmap1_gw"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#18dcc2" original="#18dcc2" id="jqvmap1_gn"
                            class="jqvmap-region"></path><path
                            d="M413.93,313.13l5.65,5.46l4.03-4.89l-2.52-3.95l-3.47,0.35L413.93,313.13L413.93,313.13z"
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#19dec1" original="#19dec1" id="jqvmap1_sl"
                            class="jqvmap-region"></path><path
                            d="M420.17,319.19l10.98,7.34l-0.26-5.56l-3.32-3.91l-3.24-2.87L420.17,319.19L420.17,319.19z"
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#19e0bf" original="#19e0bf" id="jqvmap1_lr"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#16d7c7" original="#16d7c7" id="jqvmap1_ci"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#17dac4" original="#17dac4" id="jqvmap1_ml"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#17dbc4" original="#17dbc4" id="jqvmap1_bf"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#12ced1" original="#12ced1" id="jqvmap1_ng"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#15d5ca" original="#15d5ca" id="jqvmap1_tn"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#14d3cc" original="#14d3cc" id="jqvmap1_ly"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#12cdd1" original="#12cdd1" id="jqvmap1_eg"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#17dbc4" original="#17dbc4" id="jqvmap1_td"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#14d3cb" original="#14d3cb" id="jqvmap1_sd"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#15d6c8" original="#15d6c8" id="jqvmap1_et"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#15d6c8" original="#15d6c8" id="jqvmap1_ye"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#19dec1" original="#19dec1" id="jqvmap1_cf"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#1ae2bd" original="#1ae2bd" id="jqvmap1_st"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#16d9c6" original="#16d9c6" id="jqvmap1_gq"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#17d9c5" original="#17d9c5" id="jqvmap1_ga"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#17dac5" original="#17dac5" id="jqvmap1_cg"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#14d2cd" original="#14d2cd" id="jqvmap1_ao"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#17d9c5" original="#17d9c5" id="jqvmap1_cd"
                            class="jqvmap-region"></path><path
                            d="M537.82,339.9l2.81,2.59l-0.12,2.77l-4.36,0.09v-3.06L537.82,339.9L537.82,339.9z"
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#18dcc3" original="#18dcc3" id="jqvmap1_rw"
                            class="jqvmap-region"></path><path
                            d="M536.21,346.21l4.27-0.09l-1.11,3.74l-1.08,0.94h-1.32l-0.94-2.53L536.21,346.21L536.21,346.21z"
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#19dfc0" original="#19dfc0" id="jqvmap1_bi"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#16d8c6" original="#16d8c6" id="jqvmap1_ug"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#15d6c9" original="#15d6c9" id="jqvmap1_ke"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#16d7c7" original="#16d7c7" id="jqvmap1_tz"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#16d9c6" original="#16d9c6" id="jqvmap1_zm"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#18dcc3" original="#18dcc3" id="jqvmap1_mw"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#17dac5" original="#17dac5" id="jqvmap1_mz"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#18dcc3" original="#18dcc3" id="jqvmap1_zw"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#17dac5" original="#17dac5" id="jqvmap1_na"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#17d9c5" original="#17d9c5" id="jqvmap1_bw"
                            class="jqvmap-region"></path><path
                            d="M540.87,414l-2.51,0.42l-1.08,2.95l1.92,1.75h2.33l1.97-2.83L540.87,414L540.87,414z"
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#18ddc2" original="#18ddc2" id="jqvmap1_sz"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#19dec0" original="#19dec0" id="jqvmap1_ls"
                            class="jqvmap-region"></path><path
                            d="M534.16,403.63l-7.9,7.3l-1.88,4.51l-6.26-0.78l-5.21,4.63l-3.46-0.34l0.28-6.4l-1.23-0.43l-0.86,13.09l-6.14-0.06l-1.85-2.18l-2.71-0.03l2.47,7.09l4.41,4.17l-3.15,3.67l2.04,4.6l4.72,1.8l3.76-3.2l10.77,0.06l0.77-0.96l4.78-0.84l16.17-16.1l-0.06-5.07l-1.73,2.24h-2.59l-3.15-2.64l1.6-3.98l2.75-0.56l-0.25-8.18L534.16,403.63L534.16,403.63z M530.37,422.13l1.51-0.06l2.45,2.66l-0.07,3.08l-2.87,1.45l-0.18,1.02l-4.38,0.05l-1.37-3.3l1.25-2.42L530.37,422.13L530.37,422.13z"
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#11cbd4" original="#11cbd4" id="jqvmap1_za"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#0dc2dc" original="#0dc2dc" id="jqvmap1_au"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#13d0cf" original="#13d0cf" id="jqvmap1_nz"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#12cdd1" original="#12cdd1" id="jqvmap1_my"
                            class="jqvmap-region"></path><path
                            d="M779.77,319.25l-2.88,3.49l2.36,0.74l1.33-1.86L779.77,319.25L779.77,319.25z"
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#17dac5" original="#17dac5" id="jqvmap1_bn"
                            class="jqvmap-region"></path><path
                            d="M806.14,368.42l-5.11,4.26l0.49,1.09l2.16-0.4l2.55-2.38l5.01-0.69l-0.98-1.68L806.14,368.42L806.14,368.42z"
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#1ae0be" original="#1ae0be" id="jqvmap1_tl"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#19e0bf" original="#19e0bf" id="jqvmap1_sb"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#19e0bf" original="#19e0bf" id="jqvmap1_vu"
                            class="jqvmap-region"></path><path
                            d="M948.62,412.29l-1.24,1.66l-0.1,1.87l1.44,1.46L948.62,412.29L948.62,412.29z"
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#18ddc2" original="#18ddc2" id="jqvmap1_fj"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#12ced0" original="#12ced0" id="jqvmap1_ph"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#07b4ea" original="#07b4ea" id="jqvmap1_cn"
                            class="jqvmap-region"></path><path
                            d="M787.46,248.31l-3.54,2.7l-0.19,5.2l3.06,3.56l0.76-0.67L787.46,248.31L787.46,248.31z"
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#10c9d5" original="#10c9d5" id="jqvmap1_tw"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#08b5ea" original="#08b5ea" id="jqvmap1_jp"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#0dc1de" original="#0dc1de" id="jqvmap1_ru"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#03a9f5" original="#03a9f5" id="jqvmap1_us"
                            class="jqvmap-region"></path><path
                            d="M613.01,398.99l-1.52,1.99l0.3,2.15l3.2-2.61L613.01,398.99L613.01,398.99z"
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#17dac4" original="#17dac4" id="jqvmap1_mu"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#17dbc4" original="#17dbc4" id="jqvmap1_mg"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#1ae1be" original="#1ae1be" id="jqvmap1_km"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#19e0bf" original="#19e0bf" id="jqvmap1_sc"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#19dfc0" original="#19dfc0" id="jqvmap1_mv"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#12cdd1" original="#12cdd1" id="jqvmap1_pt"
                            class="jqvmap-region"></path><path
                            d="M415.62,253.73l-1.75,1.01l0.81,0.82L415.62,253.73L415.62,253.73M409.54,253.92l-2.17,0.55l1.08,1.64h1.63L409.54,253.92L409.54,253.92M404.38,252.28l-1.36,1.37l1.9,1.64l1.08-2.46L404.38,252.28L404.38,252.28M448.36,205h-12.74l-2.57-1.16l-1.24,0.09l-1.5,3.12l0.53,3.21l4.87,0.45l0.62,2.05l-2.12,11.95l0.09,2.14l3.45,1.87l3.98,0.27l7.96-1.96l3.89-4.9l0.09-4.99l6.9-6.24l0.35-2.76l-6.28-0.09L448.36,205L448.36,205M461.1,217.21l-1.59,0.54l0.35,1.43h2.3l0.97-1.07L461.1,217.21L461.1,217.21z"
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#0dc1dd" original="#0dc1dd" id="jqvmap1_es"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#19dfc0" original="#19dfc0" id="jqvmap1_cv"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#17dbc3" original="#17dbc3" id="jqvmap1_ht"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#17d9c5" original="#17d9c5" id="jqvmap1_is"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#10cad5" original="#10cad5" id="jqvmap1_no"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#15d5ca" original="#15d5ca" id="jqvmap1_lk"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#17dbc4" original="#17dbc4" id="jqvmap1_bs"
                            class="jqvmap-region"></path><path
                            d="M238.93,279.59l-3.48,0.88v0.97l2.03,1.17h2.13l1.35-1.56L238.93,279.59L238.93,279.59z"
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#17d9c6" original="#17d9c6" id="jqvmap1_jm"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#14d4cb" original="#14d4cb" id="jqvmap1_ec"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#0cc0de" original="#0cc0de" id="jqvmap1_ca"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#15d5c9" original="#15d5c9" id="jqvmap1_gt"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#16d7c8" original="#16d7c8" id="jqvmap1_pa"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#11ccd3" original="#11ccd3" id="jqvmap1_co"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#11ccd3" original="#11ccd3" id="jqvmap1_ve"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#19dec1" original="#19dec1" id="jqvmap1_gy"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#18ddc2" original="#18ddc2" id="jqvmap1_sr"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#13cfcf" original="#13cfcf" id="jqvmap1_pe"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#16d8c7" original="#16d8c7" id="jqvmap1_bo"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#16d8c6" original="#16d8c6" id="jqvmap1_py"
                            class="jqvmap-region"></path><path
                            d="M300.36,431.93l-2.05,2.19l0.85,11.78l6.44,1.87l8.19-8.21L300.36,431.93L300.36,431.93z"
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#15d5c9" original="#15d5c9" id="jqvmap1_uy"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#11cbd4" original="#11cbd4" id="jqvmap1_ar"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#12ced1" original="#12ced1" id="jqvmap1_cl"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#0bbee0" original="#0bbee0" id="jqvmap1_br"
                            class="jqvmap-region"></path><path
                            d="M204.56,282.4l-0.05,3.65h0.84l2.86-5.34h-1.94L204.56,282.4L204.56,282.4z"
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#19dfc0" original="#19dfc0" id="jqvmap1_bz"
                            class="jqvmap-region"></path><path
                            d="M673.8,170.17l5.82-7.72l6.99,3.23l4.75,1.27l5.82-5.34l-3.95-2.91l2.6-3.67l7.76,2.74l2.69,4.41l4.86,0.13l2.54-1.89l5.23-0.21l1.14,1.94l8.69,0.44l5.5-5.61l7.61,0.8l-0.44,7.64l3.33,0.76l4.09-1.86l4.33,2.14l-0.1,1.08l-3.14,0.09l-3.27,6.86l-2.54,0.25l-9.88,12.91l-10.09,4.45l-6.31,0.49l-5.24-3.38l-6.7,3.58l-6.6-2.05l-1.87-4.79l-12.5-0.88l-6.4-10.85l-3.11-0.2L673.8,170.17L673.8,170.17z"
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#18dcc3" original="#18dcc3" id="jqvmap1_mn"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#0ec4db" original="#0ec4db" id="jqvmap1_kr"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#13d0ce" original="#13d0ce" id="jqvmap1_kz"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#1de9b6" original="#1de9b6" id="jqvmap1_tm"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#15d6c9" original="#15d6c9" id="jqvmap1_uz"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#18dcc3" original="#18dcc3" id="jqvmap1_tj"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#18dcc2" original="#18dcc2" id="jqvmap1_kg"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#16d9c6" original="#16d9c6" id="jqvmap1_af"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#12cfd0" original="#12cfd0" id="jqvmap1_pk"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#0dc1de" original="#0dc1de" id="jqvmap1_in"
                            class="jqvmap-region"></path><path
                            d="M671.19,242.56l0.46,4.27l8.08,3.66l12.95,0.96l-0.49-3.13l-8.65-2.38l-7.34-4.37L671.19,242.56L671.19,242.56z"
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#16d9c6" original="#16d9c6" id="jqvmap1_np"
                            class="jqvmap-region"></path><path
                            d="M695.4,248.08l1.55,2.12l5.24,0.04l-0.53-2.9L695.4,248.08L695.4,248.08z" stroke="#818181"
                            stroke-width="1" stroke-linecap="round" stroke-linejoin="round" stroke-opacity="0.25"
                            fill="#19dfc0" original="#19dfc0" id="jqvmap1_bt" class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#13d1cd" original="#13d1cd" id="jqvmap1_bd"
                            class="jqvmap-region"></path><path
                            d="M729.44,303.65l-2.77-4.44l2.01-2.82l-1.9-3.49l-1.79-0.34l-0.34-5.86l-2.68-5.19l-0.78,1.24l-1.79,3.04l-2.24,0.34l-1.12-1.47l-0.56-3.95l-1.68-3.16l-6.84-6.45l1.68-1.11l0.31-4.67l2.5-4.2l1.08-10.45l3.62-2.47l0.12-3.81l2.17,0.72l3.42,4.95l-2.54,5.44l1.71,4.27l4.23,1.66l0.77,4.65l5.68,0.88l-1.57,2.71l-7.16,2.82l-0.78,4.62l5.26,6.76l0.22,3.61l-1.23,1.24l0.11,1.13l3.92,5.75l0.11,5.97L729.44,303.65L729.44,303.65z"
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#15d6c9" original="#15d6c9" id="jqvmap1_mm"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#11cbd3" original="#11cbd3" id="jqvmap1_th"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#17dac5" original="#17dac5" id="jqvmap1_kh"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#17dbc3" original="#17dbc3" id="jqvmap1_la"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#15d4ca" original="#15d4ca" id="jqvmap1_az"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#11cbd4" original="#11cbd4" id="jqvmap1_ir"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#0fc6d9" original="#0fc6d9" id="jqvmap1_tr"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#10c9d5" original="#10c9d5" id="jqvmap1_sa"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#14d4cb" original="#14d4cb" id="jqvmap1_sy"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#14d2cc" original="#14d2cc" id="jqvmap1_iq"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#0bbde1" original="#0bbde1" id="jqvmap1_gb"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#12ced1" original="#12ced1" id="jqvmap1_ie"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#10c9d5" original="#10c9d5" id="jqvmap1_se"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#12cdd2" original="#12cdd2" id="jqvmap1_fi"
                            class="jqvmap-region"></path><path
                            d="M518.07,151.37l-6.85-1.11l0.15,3.83l6.35,3.88l2.6-0.76l-0.15-2.92L518.07,151.37L518.07,151.37z"
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#16d7c7" original="#16d7c7" id="jqvmap1_lv"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#15d6c9" original="#15d6c9" id="jqvmap1_lt"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#15d4ca" original="#15d4ca" id="jqvmap1_by"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#10c9d5" original="#10c9d5" id="jqvmap1_pl"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#0bbee0" original="#0bbee0" id="jqvmap1_it"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#0bbce2" original="#0bbce2" id="jqvmap1_fr"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#0fc5d9" original="#0fc5d9" id="jqvmap1_nl"
                            class="jqvmap-region"></path><path
                            d="M461.61,176.52l-0.64,1.6l6.88,4.54l1.98,0.47l0.07-2.15l-1.73-1.94h-1.06l-1.45-1.65L461.61,176.52L461.61,176.52z"
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#10c9d6" original="#10c9d6" id="jqvmap1_be"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#0ab9e5" original="#0ab9e5" id="jqvmap1_de"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#11cbd3" original="#11cbd3" id="jqvmap1_dk"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#10c8d6" original="#10c8d6" id="jqvmap1_ch"
                            class="jqvmap-region"></path><path
                            d="M488.43,184.87h2.97h1.46l2.37,1.69l4.39-3.65l-4.26-3.04l-4.22-2.04l-2.89,0.52l-3.92,2.52L488.43,184.87L488.43,184.87z"
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#12ced1" original="#12ced1" id="jqvmap1_cz"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#14d2cd" original="#14d2cd" id="jqvmap1_sk"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#11cad4" original="#11cad4" id="jqvmap1_at"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#13d0cf" original="#13d0cf" id="jqvmap1_hu"
                            class="jqvmap-region"></path><path
                            d="M494.8,191.99l-2.54,1.52l-4.74,1.04l0.95,2.74l3.32,0.04l3.06-2.56L494.8,191.99L494.8,191.99z"
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#15d5ca" original="#15d5ca" id="jqvmap1_si"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#14d4cb" original="#14d4cb" id="jqvmap1_hr"
                            class="jqvmap-region"></path><path
                            d="M494.8,198.94l-0.37,0.61l6.71,6.92l2.46-3.62l-0.09-1.43l-2.15-2.61L494.8,198.94L494.8,198.94z"
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#16d9c6" original="#16d9c6" id="jqvmap1_ba"
                            class="jqvmap-region"></path><path
                            d="M492.61,230.47l-1.67,0.34l0.06,1.85l1.5,0.5l0.67-0.56L492.61,230.47L492.61,230.47z"
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#17dbc4" original="#17dbc4" id="jqvmap1_mt"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#13d0cf" original="#13d0cf" id="jqvmap1_ua"
                            class="jqvmap-region"></path><path
                            d="M520.75,187.71l3.1,4.77l-0.26,2.7l1.11,0.05l2.63-4.45l-3.16-3.92l-1.79-0.74L520.75,187.71L520.75,187.71z"
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#18dcc3" original="#18dcc3" id="jqvmap1_md"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#12cfcf" original="#12cfcf" id="jqvmap1_ro"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#15d5c9" original="#15d5c9" id="jqvmap1_rs"
                            class="jqvmap-region"></path><path
                            ...
                            stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-opacity="0.25" fill="#11cbd3" original="#11cbd3" id="jqvmap1_gr"
                            class="jqvmap-region"></path></g></svg>

                    <div class="jqvmap-zoomin">+</div>

                    <div class="jqvmap-zoomout">−</div></div>
            </div>
        </div>
        <!-- /# card -->
    </div>
